  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-[#0d1b3e]/85 via-[#0d1b3e]/70 to-[#0d1b3e]/95" />
        {/* Red accent stripe */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8 text-center flex flex-col items-center gap-6">
        {/* Year badge */}
        <div className="inline-flex items-center gap-2 bg-[#c8102e] text-white text-xs font-black uppercase tracking-widest px-4 py-1.5 rounded-sm">
          <span>2026</span>
        ...
        <h1 className="text-white font-black uppercase leading-none text-balance" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
          ...
          <span className="block text-6xl md:text-8xl lg:text-9xl text-[#c8102e] tracking-tight mt-1">"B" Nacional</span>
        </h1>
        ...
        <a
          href="#cronograma"
          className="mt-4 inline-flex items-center gap-2 bg-[#c8102e] hover:bg-[#a80d26] text-white font-black uppercase tracking-widest text-sm px-8 py-4 rounded-sm transition-all duration-200 shadow-lg shadow-[#c8102e]/30 hover:shadow-[#c8102e]/50 hover:-translate-y-0.5"
        >
          Ver Cronograma
          <ChevronDown size={16} />
        </a>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 md:gap-8">
          <div className="flex flex-col items-center">
            <Image
              src="\images\logos\organizaciones\logo CAP patinaje.png"
              alt="Logo CAP"
              width={80}
              height={80}
              className="object-contain w-16 h-16 md:w-24 md:h-24 p-2"
              priority
            />
          </div>
          <div className="flex flex-col items-center">
            <Image
              src="\images\logos\organizaciones\Logo FEMIPAT_septiembre2020.png"
              alt="Logo FEMIPAT"
              width={80}
              height={80}
              className="object-contain w-16 h-16 md:w-24 md:h-24  p-2"
          ...
          <div className="flex flex-col items-center">
            <Image
              src="\images\logos\organizaciones\LOGO MINISTERIO DE DEPORTES_page-0001.jpg"
          ...
          <div className="flex flex-col items-center">
            <Image
              src="\images\logos\organizaciones\LOGO MUNICIPALIDAD DE POSADAS.jpg"
              alt="Logo Posadas"
              width={80}
              height={80}
              className="object-contain w-16 h-16 md:w-20 md:h-20 rounded-2xl p-2"
              priority
            />
          </div>
        </div>
